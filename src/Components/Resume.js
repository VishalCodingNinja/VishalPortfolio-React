      ...
      return (
         <section id="resume">
            ...
            <div className="row skill">
               ...
               <div className="nine columns main-col">
                  <p>The main skill sets below outline the variety of skills performed within my current role as Lead Software Engineer at RDA Labs Pvt ltd, Bangalore, India..
                  </p>
                  <div className="bars">
                     <ul className="skills">
                        {skills}
